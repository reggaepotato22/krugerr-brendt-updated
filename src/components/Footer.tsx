      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-20 text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start space-y-4">
            ...
            <div className="flex items-center gap-3 text-gray-400 hover:text-primary transition-colors cursor-pointer">
              <MapPin className="w-4 h-4 text-primary" />
              <span className="text-sm tracking-wide">Head Office: Kilifi, Kenya</span>
            </div>
            <div className="flex items-center gap-3 text-gray-400 hover:text-primary transition-colors cursor-pointer">
              <Phone className="w-4 h-4 text-primary" />
              <span className="text-sm tracking-wide">+254 700 000 000</span>
            </div>
            <div className="flex items-center gap-3 text-gray-400 hover:text-primary transition-colors cursor-pointer">
