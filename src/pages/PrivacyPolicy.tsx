    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="pt-32 pb-12 container mx-auto px-6 flex-grow">
        <div className="bg-white p-8 md:p-12 shadow-sm rounded-sm max-w-4xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-serif text-secondary mb-2">Privacy Policy</h1>
          ...
          <div className="prose prose-stone max-w-none text-gray-600 space-y-6">
            ...
            <h3 className="text-xl font-bold text-secondary mt-6 mb-2">1. Information We Collect</h3>
            <p>
            ...
            <h3 className="text-xl font-bold text-secondary mt-6 mb-2">2. How We Use Your Information</h3>
            <p>
            ...
            <h3 className="text-xl font-bold text-secondary mt-6 mb-2">3. Data Security</h3>
            <p>
            ...
            <h3 className="text-xl font-bold text-secondary mt-6 mb-2">4. Third-Party Sharing</h3>
            <p>
            ...
            <h3 className="text-xl font-bold text-secondary mt-6 mb-2">5. Contact Us</h3>
            <p>
