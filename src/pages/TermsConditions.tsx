    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="pt-32 pb-12 container mx-auto px-6 flex-grow">
        <div className="bg-card p-8 md:p-12 shadow-sm rounded-sm max-w-4xl mx-auto border border-border">
          <h1 className="text-3xl md:text-4xl font-serif text-foreground mb-2">Terms & Conditions</h1>
          ...
          <div className="prose prose-stone max-w-none text-muted-foreground space-y-6">
            ...
            <h3 className="text-xl font-bold text-foreground mt-6 mb-2">1. Acceptance of Terms</h3>
            <p>
            ...
            <h3 className="text-xl font-bold text-foreground mt-6 mb-2">2. Intellectual Property</h3>
            <p>
            ...
            <h3 className="text-xl font-bold text-foreground mt-6 mb-2">3. Property Information</h3>
            <p>
            ...
            <h3 className="text-xl font-bold text-foreground mt-6 mb-2">4. Limitation of Liability</h3>
            <p>
            ...
            <h3 className="text-xl font-bold text-foreground mt-6 mb-2">5. Governing Law</h3>
            <p>
